...
export const InfoBlock = ({
  ...
  return <div className='info-block__wrap'>
    <div className='info-block__group'>
      <p className='info-block__item info-block__item--yellow'>Медіана <span className='info-block__tooltip' data-tooltip={`
      ...
      `}>i</span>:  <Price price={median}/></p>
      <p className='info-block__item info-block__item--yellow-dashed'>1 квартиль <span className='info-block__tooltip' data-tooltip={`
      ...
      `}>i</span>: <Price price={quartile1}/></p>
      <p className='info-block__item info-block__item--yellow-dashed'>3 квартиль <span className='info-block__tooltip' data-tooltip={`
      ...
      `}>i</span>: <Price price={quartile3}/></p>
      <p className='info-block__item'>Міжквартильний розмах <span className='info-block__tooltip' data-tooltip={`
      ...
      `}>i</span>: <Price price={quartile3 - quartile1}/></p>
    </div>
    <div className='info-block__group'>
      <p className='info-block__item info-block__item--red'>Середнє значення <span className='info-block__tooltip' data-tooltip={`
      ...
      `}>i</span>: <Price price={average}/></p>
      <p className='info-block__item'>Стандартне відхилення <span className='info-block__tooltip' data-tooltip={`
      ...
      `}>i</span>: <Price price={standardDeviation}/></p>
      <p className='info-block__item info-block__item--red-dashed'>Мінімальне значення (68%) <span className='info-block__tooltip' data-tooltip={`
      ...
      `}>i</span>: <Price price={average - standardDeviation}/></p>
      <p className='info-block__item info-block__item--red-dashed'>Максимальне значення (68%) <span className='info-block__tooltip' data-tooltip={`
